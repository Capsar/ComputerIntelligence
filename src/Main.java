...
public class Main {
    public static void main(String[] args) {
        ...
        TrainParameters parameters = new TrainParameters(7, 8, 0.1, 1.0, 0.1, new double[]{0, 0}, new double[]{0, 0}, new double[]{0, 0}, new double[]{0, 0}, 0.5);
        trainer.createParameterFile(parameters, 2, 1);
        }
        }
